(function () {
  ...
  const fallbackAuthors = [
    {
      ...
      name: "David Alvarez",
      slug: "david-alvarez",
      role: "Lead Climate Correspondent",
      bio: "David Alvarez reports from the frontlines of climate science, public policy, and forest ecology.",
  ...
  const fallbackCategories = [
    ...
    { id: "news", title: "News", slug: "news", description: "Daily climate reporting and evidence-based newsroom coverage." },
  ...
  const fallbackArticles = [
    ...
    },
    {
      ...
      excerpt: "A reported climate news story on how architectural materials and structural planning create hyper-localized thermal pressure cookers.",
      ...
      seoTitle: "Urban Heat Islands News Report",
    ...
    },
    {
      ...
      excerpt: "Reporting on the transmission line shortages that keep gigawatts of wind and solar power locked out of local households.",
    ...
    },
    {
      ...
      excerpt: "A reported news feature on how energy companies buy worthless carbon offsets from unmanaged forests.",
  ...
  function normalizeArticle(article) {
    ...
    return {
      ...
      bodyBlocks: article.bodyBlocks || article.body || [],
      tags: article.tags || [],
